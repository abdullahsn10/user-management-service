...
from src.helpers import branch
...
def _is_user_exist(
    ...
    email: str = None,
    phone_no: str = None,
    excluded_user_id: list[int] = None,
) -> bool:
    """
    ...
    *Args:
        ...
        excluded_user_id (list[int]): The user ids to exclude from the check.
    *Returns:
...
def full_update_user(
    ...
    *Returns:
    ...
    # update the user
    updated_user = _update_user(request=request, db=db, user_instance=user_instance)
...
def restore_deleted_user(
    ...
    *Returns:
        UserResponse: The restored user details.
    """
